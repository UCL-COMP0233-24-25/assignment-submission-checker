...
# def test_from_json(test_data_assignment: Assignment, template_dir_structure: Directory) -> None:
#     assert test_data_assignment.year == 2024
#     assert test_data_assignment.assignment_id == "01"

#     assert (
#         test_data_assignment.directory_structure == template_dir_structure
